...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.menu-item, .contact-item, .about-text');
...
// Add loading animation to restaurant preview
document.querySelectorAll('.restaurant-preview').forEach(preview => {
