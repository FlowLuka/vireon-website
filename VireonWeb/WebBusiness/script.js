...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        const websiteType = this.querySelector('input[placeholder*="Website Type"]').value;
...
// Add loading animation to website mockups
document.querySelectorAll('.website-mockup, .website-preview').forEach(mockup => {
